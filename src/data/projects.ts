...
export const projects: Project[] = [
  {
    ...
    icon: Layers,
    summary:
      "Substituição do SAP BW + Fabric por Databricks Lakehouse e SAP Datasphere com arquitetura Medallion.",
    problem:
  ...
  },
  {
    ...
    icon: Cable,
    summary:
      "Eliminação da dependência de consultoria SAP com capacidade técnica interna em ABAP e integrações.",
    problem:
  ...
  },
  {
    ...
    icon: Zap,
    summary:
      "Automações que substituíram horas de trabalho manual por minutos, impactando toda a empresa.",
    problem:
  ...
  },
  {
    ...
    icon: RefreshCw,
    summary:
      "Desenvolvimento interno em Delphi para sistema frigorífico, eliminando consultoria externa recorrente.",
    problem:
